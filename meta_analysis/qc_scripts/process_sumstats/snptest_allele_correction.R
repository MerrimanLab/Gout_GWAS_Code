...
#
# This is a script to solve this problem by aligning all the variants to the
# A allele (i.e. A allele is the minor allele).
...
data$flip = data$all_AA < data$all_BB
data$flip_case = data$cases_AA < data$cases_BB
data$flip_control = data$controls_AA < data$controls_BB
...
maf_half = which(data$all_AA == data$all_BB)
