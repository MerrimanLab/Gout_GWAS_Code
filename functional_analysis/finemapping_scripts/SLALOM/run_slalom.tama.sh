...
#
# NOTE: Only run this script with max. 5 instances with parallel, due to memory
# requirement (it needs a lot of memory for some loci)
...
python src/slalom/slalom.py \
    ...
    --weighted-average-r afr=n_afr amr=n_lat eas=n_eas nfe=n_eur \
